...
//class HeroListViewController: HeroTableViewController, UITextFieldDelegate {
//
//    private var heroTableViewController: HeroTableViewController!
//    private var heroListView: HeroListView!
//
...
//        heroListView.setupViews()
//        view.addSubview(heroListView)
//
//        self.heroListView.searchBox.delegate = self
//
//        heroTableViewController = HeroTableViewController()
//        heroListView.addHeroTableView(heroTableView: heroTableViewController.view)
//        addChild(heroTableViewController)
//        heroTableViewController.didMove(toParent: self)
//    }
//
//    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
//        if textField == self.heroListView.searchBox {
//           //any task to perform
//            if let isEmpty = textField.text?.isEmpty{
//                if isEmpty {
//                    self.heroTableViewController.viewModel.searchFor = .none
//                } else {
//                    self.heroTableViewController.viewModel.searchFor = textField.text
//                }
//            }
//            self.heroTableViewController.viewModel.heroes = []
//            self.heroTableViewController.viewModel.offset = 0
//            self.heroTableViewController.viewModel.totalHeroes = 0
//            if self.heroTableViewController.tableView.numberOfRows(inSection: 0) != 0 {
//                self.heroTableViewController.tableView.scrollToRow(at: IndexPath(row: 0, section: 0), at: .top, animated: true)
//            }
//            self.heroTableViewController.viewModel.fetchCharacters()
//
